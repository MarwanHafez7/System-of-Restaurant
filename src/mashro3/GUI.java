...
//    ImageIcon mpg8 = new ImageIcon(getClass().getResource("Back Ground.JPEG"));
    JLabel imageLabel8;
...
public void modfiy_form(int id)
  ...
  //makeOrder attributes  
    ...
    ImageIcon mpg2 = new ImageIcon(getClass().getResource("Pizza.jpeg"));
    JLabel imageLabel2;
   ...
   //image attribute 
    ...
    ImageIcon mpg5 = new ImageIcon(getClass().getResource("Pii.jpeg"));
    JLabel imageP;
   ...
   public void make_order(int id)
   {
     ...
     //  Categroies.setBackground(Color.YELLOW);
      ...
      Categroies.addItemListener(this);
             ...
             try {
       pepprony=new ImageIcon(getClass().getResource("pepprony.JPEG"));
       MixMeat=new ImageIcon(getClass().getResource("mixmeat.JPEG"));
       Chicken=new ImageIcon(getClass().getResource("chicken.JPEG"));
       Cheese=new ImageIcon(getClass().getResource("cheese.jpeg"));
       Margretta=new ImageIcon(getClass().getResource("margretta.jpeg"));
        ...
        if(e.getSource()==ManageBtn)
        {
         ...
         confirm_order(ID);
            ...
            if(e.getSource()==deliver)
           {
               ...
               {
                   r=db.retreive_Userdata("users");
                   ResultSet r2=db.retreive_Userdata("credits");
                   try {
                       while(r.next())
                       {
                           if(r.getInt("id")==ID)
                           {
                               if(r.getString("name")==r2.getString("name"))
                               {
                                   if(Integer.parseInt(TotalPrice.getText())<=r2.getInt("balance"))
                                   {
                                       db.Modify_balance(r2.getInt("balance")-Integer.parseInt(TotalPrice.getText()), r2.getInt("creditNumber"));
